...
//}
//
//void Text::Draw(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, GLint texture, const float time)
//{
//
//	GLuint tex;
...
void Text::display() {	
	...
	render_text("The Quick Brown Fox Jumps Over The Lazy Dog", -1.0f + 8.0f * sx, 1.0f - 50.0f * sy, sx, sy);
